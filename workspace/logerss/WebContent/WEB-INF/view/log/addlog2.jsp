  ...
  <!-- page Start -->
	...
	<div class="row">
			<div class="col-xs-6 col-md-4" style="text-align: center; height:17em;">
				...
				<p><a class="btn btn-default" href="/view/log/addlog/map" role="button">add log<span class="fa fa-plus" aria-hidden="true"></span></a></p>
			</div>
			...
			<div class="col-xs-6 col-md-4" style="text-align: center; height:17em;">
				...
				<p><a class="btn btn-default" href="/view/log/addlog/data" role="button">add log<span class="fa fa-plus" aria-hidden="true"></span></a></p>
			</div>
			...
			<div class="col-xs-6 col-md-4" style="text-align: center; height:17em;">
				...
				<h2>Weather</h2>
				<p>Weather log</p>
				<p><a class="btn btn-default" href="/view/log/addlog/weather" role="button">add log<span class="fa fa-plus" aria-hidden="true"></span></a></p>
			</div>
			<div class="col-xs-6 col-md-4" style="text-align: center; height:17em;">
