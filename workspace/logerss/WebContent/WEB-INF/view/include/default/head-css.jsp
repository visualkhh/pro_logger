<%@page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    <!-- Bootstrap core CSS -->
    <link href="/front-end/bootstrap/3.3.6/dist/css/bootstrap.min.css" rel="stylesheet">
...
/* 	  max-width: none !important; */
	...
	.blockquote-box.blockquote-forestgreen{border-color:forestgreen}
	.blockquote-box.blockquote-forestgreen .square{background-color:forestgreen;color:#FFF}
